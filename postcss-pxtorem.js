...
module.exports = (options = {}) => {
  ...
  return {
    ...
    Declaration(decl) {
      ...
      const rootValue = typeof opts.rootValue === 'function' ? opts.rootValue(decl.source.input) : opts.rootValue;
      const value = decl.value.replace(pxRegex(opts.unit), createPxReplace(rootValue, opts.unitPrecision, opts.minPixelValue));
