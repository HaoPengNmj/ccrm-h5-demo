...
-->
<template>
  <van-nav-bar :title="`客户${currentRemind?.title}`" fixed left-arrow @click-left="router.back()">
    <template #right>
      <div @click="readAllFn">
        ...
        <van-dropdown-menu ref="dropdownMenuRef">
          <van-dropdown-item>
            ...
            <van-form class="gform" @submit="onSubmit">
              <van-cell-group>
                <van-field v-model="queryParams.custId" name="radio" label="客户号" input-align="right" disabled></van-field>
