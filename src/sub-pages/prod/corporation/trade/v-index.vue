 ...
 * @LastEditTime: 2024-10-09 19:36:29
-->
<template>
  <van-sticky>
    <van-tabs v-model:active="reqParams.activeTab" @change="onSearch">
      <van-tab v-for="item in getCombo(moduleComp.corporation.trade.codeCombo)" :name="item.value" :title="item.content"></van-tab>
    </van-tabs>
...
defineOptions({ name: 'corporation-trade' });
...
// 请求参数
const reqParams = ref({
  kindProdType: moduleComp.corporation.trade.kindProdType,
...
const handleClick = (item: any) => {
  router.push(`/prod-dtl/corporation/trade/${item.prodId}`);
};
</script>
